...
exports.rules = {
    ...
    pre: [
        { rex:/(\n|\r\n?)/g, tmplt:"\xB6" },  // replace line breaks with paragraph symbol ..
    ],
    post: [
        { rex:/(^\xB6)|(\xB6$)/g, tmplt:"" },  // .. remove linebreaks at BOS and EOS ..
        { rex:/@([0-9]+)@/g, tmplt:function($0,$1){return exports.restore($1);} }, // resolve blocks ..
        { rex:/\xB6/g, tmplt:"\n" } // replace paragraph symbol with line breaks ..
    ],
    nonwikiblocks: [
        { rex:/\\([%])/g, tmplt:function($0,$1){return exports.store($1);} },
        { rex:/\[(?:\{([^}]*)\})?(?:\(([^)]*)\))?%(.*?)%\]/g, tmplt:function($0,$1,$2,$3){return ":p]"+exports.store("<pre"+($2?(" lang=\"x-"+exports.attr($2)+"\""):"")+exports.style($1)+">" + exports.apply($3, $2?exports.rules.lang[exports.attr($2)]:exports.rules.code) + "</pre>")+"[p:";} } //programm code block
    ],
    wikiblocks: [
        "rules.nonwikiinlines",
        "rules.escapes",
        ...
        { rex:/\[(?:\{([^}]*)\})?(?:\(([^)]*)\))?\"/g, tmplt:function($0,$1,$2){return ":p]<blockquote"+exports.attr($2,"cite",0)+exports.attr($2,"title",1)+exports.style($1)+">[p:"; } }, // block quotation start
        ...
        { rex:/\[([01AIacdgilprtu]+)[:](.*?)[:]([01AIacdgilprtu]+)\]/g, tmplt:function($0,$1,$2,$3){return exports.sectionRule($1==undefined?"":$1,"",exports.apply($2,exports.rules.wikiinlines),!$3?"":$3);} },
        ...
        { rex:/<(p|table)>(?:\xB6)?(?:\{(.*?)\})/g, tmplt:function($0,$1,$2){return "<"+$1+exports.style($2)+">";} },
        { rex:/<p>([ \t\f\v\xB6]*?)<\/p>/g, tmplt:"$1" },  // .. remove empty paragraphs ..
        "rules.shortcuts"
    ],
    nonwikiinlines: [
        { rex:/%(?:\{([^}]*)\})?(?:\(([^)]*)\))?(.*?)%/g, tmplt:function($0,$1,$2,$3){return exports.store("<code"+($2?(" lang=\"x-"+exports.attr($2)+"\""):"")+exports.style($1)+">" + exports.apply($3, $2?exports.rules.lang[exports.attr($2)]:exports.rules.code) + "</code>");} }, // inline code
        { rex:/%(.*?)%/g, tmplt:function($0,$1){return exports.store("<code>" + exports.apply($2, exports.rules.code) + "</code>");} }
    ],
    wikiinlines: [
        ...
        { rex:/\[(?:\{([^}]*)\})?[Ii]ma?ge?\:([^ ,\]]*)(?:[, ]([^\]]*))?\]/g, tmplt:function($0,$1,$2,$3){return exports.store("<img"+exports.style($1)+" src=\""+$2+"\" alt=\""+($3?$3:$2)+"\" title=\""+($3?$3:$2)+"\"/>");} },  // wikimedia image style ..
        { rex:/\[([^ ,]+)[, ]([^\]]*)\]/g, tmplt:function($0,$1,$2){return exports.store("<a href=\""+$1+"\">"+$2+"</a>");}},  // wiki block style uri's ..
        { rex:/(((http(s?))\:\/\/)?[A-Za-z0-9\._\/~\-:]+\.(?:png|jpg|jpeg|gif|bmp))/g, tmplt:function($0,$1,$2){return exports.store("<img src=\""+$1+"\" alt=\""+$1+"\"/>");} },  // simple images .. 
        { rex:/((mailto\:|javascript\:|(news|file|(ht|f)tp(s?))\:\/\/)[A-Za-z0-9\.:_\/~%\-+&#?!=()@\x80-\xB5\xB7\xFF]+)/g, tmplt:"<a href=\"$1\">$1</a>" }  // simple uri's .. 
    ],
    escapes: [
        { rex:/\\([|*_~\^])/g, tmplt:function($0,$1){return exports.store($1);} },
        { rex:/\\&/g, tmplt:"&amp;" },
        { rex:/\\>/g, tmplt:"&gt;" },
        { rex:/\\</g, tmplt:"&lt;" }
    ],
...
exports.inverse = {
    all: [
        "inverse.pre",
        "inverse.nonwikiblocks",
        "inverse.wikiblocks",
        "inverse.post"
    ],
    pre: [
        { rex:/(\r?\n)/g, tmplt:"\xB6" }    // replace line breaks with a literal paragraph symbol ..
    ],
    post: [
        { rex:/@([0-9]+)@/g, tmplt:function($0,$1){return exports.restore($1);} },  // resolve blocks ..
        { rex:/\xB6/g, tmplt:"\n" }  // replace pargagraph symbol with line breaks ..
    ],
    nonwikiblocks: [
        { rex:/<pre([^>]*)>(.*?)<\/pre>/mgi, tmplt:function($0,$1,$2){return exports.store("["+exports.invStyle($1)+exports.invAttr($1,["lang"]).replace(/x\-/,"")+"%"+exports.apply($2, exports.hasAttr($1,"lang")?exports.inverse.lang[exports.attrVal($1,"lang").substr(2)]:exports.inverse.code)+"%]");} } //code block
    ],
    wikiblocks: [
        "inverse.nonwikiinlines",
        "inverse.escapes",
        "inverse.wikiinlines",
        ...
        { rex:/<(p|table)[^>]+(style=\"[^\"]*\")[^>]*>/mgi, tmplt:function($0,$1,$2){return "<"+$1+">"+exports.invStyle($2);} },
        ...
        { rex:/<dt>(.*?)<\/dt>[ \f\n\r\t\v]*<dd>/mgi, tmplt:"; $1: " },
        { rex:/<blockquote([^>]*)>/mgi, tmplt:function($0,$1){return exports.store("["+exports.invStyle($1)+exports.invAttr($1,["cite","title"])+"\"");} },
    ...
    nonwikiinlines: [
        { rex:/<code>(.*?)<\/code>/g, tmplt:function($0,$1){return exports.store("%"+exports.apply($1, exports.inverse["code"])+"%");} }
    ],
    wikiinlines: [
        ...
        { rex:/<img([^>]*)\/>/mgi, tmplt:function($0,$1){var a=exports.attrVal($1,"alt"),h=exports.attrVal($1,"src"),t=exports.attrVal($1,"title"),s=exports.attrVal($1,"style");return s||(t&&h!=t)?("["+exports.invStyle($1)+"img:"+h+(t&&(","+t))+"]"):h;}},
    ],
    escapes: [
        { rex:/([|*_~%\^])/g, tmplt:"\\$1" },
        { rex:/&amp;/g, tmplt:"\\&" },
...
exports.toHtml = function(str) {
    exports.blocks = [];
    return exports.apply(str, exports.rules.all);
};

exports.toWiki = function(str) {
    exports.blocks = [];
    return exports.apply(str, exports.inverse.all);
};

exports.apply = function(str, rules) {
    if (str && rules)
        for (var i in rules) {
            if (typeof(rules[i]) == "string")
                str = exports.apply(str, exports.resolve(rules[i]));
            else
...
exports.store = function(str, unresolved) {
   return unresolved ? "@" + (exports.blocks.push(str)-1) + "@"
       : "@" + (exports.blocks.push(str.replace(/@([0-9]+)@/g, function($0,$1){return exports.restore($1);}))-1) + "@";
};

exports.restore = function(idx) {
    return exports.blocks[idx];
};

exports.attr = function(str, name, idx) {
    var a = str && str.split(",")[idx||0];
    return a ? (name ? (" "+name+"=\""+a+"\"") : a) : "";
};

exports.hasAttr = function(str, name) {
    return new RegExp(name+"=").test(str);
};

exports.attrVal = function(str, name) {
    return str.replace(new RegExp("^.*?"+name+"=\"(.*?)\".*?$"), "$1");
};

exports.invAttr = function(str, names) {
    var a=[], x;
    for (var i in names)
...
exports.sectionRule = function(fromLevel, style, content, toLevel) {
    var trf = {
        p_p: "<p>$1</p>",
        p_u: "<p>$1</p><ul$3>",
        p_o: "<p>$1</p><ol$3>",
...
exports.main = function (system) {
    ...
    if (!system.args.length) {
        system.stdout.write(exports.toHtml(system.stdin.read())).flush();
    } else {
        var arg;
        while (arg = system.args.shift()) {
            var out = arg.replace(/.wik[iy]$/, '') + '.html';
            print(out);
            system.fs.write(out, exports.toHtml(system.fs.read(arg)));
        }
    }
};
